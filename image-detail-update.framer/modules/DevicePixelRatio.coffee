...
#
#  3. When you create a layer do so @ 1x and add the dp function to the value
#
#     rect = new Layer
#       width:  dp(300)
#       height: dp 50
...
#
#			# Add a list row w/ the height & text sizing/layout using dp()
#
#     listRow = new Layer
#       width: Screen.width
#       height: dp 44
...
#       color: "#000"
#       style:
#         font: "400 #{dp 14}px/#{dp 42}px -apple-system, Helvetica Neue"
#         textIndent: "#{dp 15}px"
#
# 		# Add a chevron with the size, right margin & shadow stroke using dp()
#
#     listChevron = new Layer
#     	superLayer: listRow
#     	width:  dp 9
#     	height: dp 9
#     	maxX: listRow.width - dp 15
#     	y:    listRow.height / 2
#     	originX: 1
#     	originY: 0
#     	rotation: 45
#     	backgroundColor: ""
#     	style:
#     		boxShadow: "inset -#{dp 2}px #{dp 2}px 0 #BCBCC1"
#
##############################################################################
